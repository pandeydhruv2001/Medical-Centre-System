...
$conn = mysqli_connect('sql104.epizy.com','epiz_34112335','EP9IILMfqBOqV','epiz_34112335_contact_db') or die('connection failed');
...
function generateAlert() {
    ...
    <section class="Appointment" id="appointment">
        ...
        <div class="container min-vh-100">
            ...
            <div class="row justify-content-center">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" onsubmit="return generateAlert()">
                        <div class="inputBox">
    ...
    <section class="footer">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4" data-aos="fade-right">
                    <a href="#" class="logo"><span>Well</span> Spring <span>Medical</span> Centre</a></a>
        ...
        <h1 class="credit text-center mx-auto">created by <span onclick="openLink('https://github.com/prajaviS')">Prajavi</span> &amp; <span onclick="openLink('https://github.com/pandeydhruv2001')">Dhruv</span></h1>
